...
if (count($V12ext3gtwse) > 0) {
    ...
    echo '<label>Account Balance<i class="text-danger">*</i></label> <input type="text" name="credit_ac_balance" class="form-control" value="' . $V1ghrtyc0rr3uery['acc_balance'] . '" readonly>';
} else {
