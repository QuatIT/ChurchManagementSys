...
//     home_town='$home_town',phone_number='$phone_number',nationality='$nationality',place_of_birth='$place_of_birth', occupation='$occupation',marital_status='$marital_status',
//     email='$email',group_name='$group_name',baptism_status='$baptism_status',confirmation_status='$confirmation_status',membership_type='$membership_type', parental_name='$parent_Name', parental_status='$parent_status', position='$position',member_image='$member_image' ");
...
<div id="myTabContent" class="tab-content">
  ...
  <div class="tab-pane fade active show" id="home">
   ...
   <div class="col-md-4" style="z-index:1">
        First Name <input type="text" name="firstname" value="<?php echo $row['first_name']; ?>" class="form-control"readonly>
      </div>
   <div class="col-md-4" style="z-index:1">
        Other Name <input type="text" name="othername" value="<?php echo $row['other_name']; ?>" class="form-control"readonly>
      </div>
   <div class="col-md-4" style="z-index:1">
        Last Name <input type="text" name="lastname" value="<?php echo $row['last_name']; ?>" class="form-control"readonly>
      </div>

   <div class="col-md-4"  style="z-index:1">
        Date of Birth <input type="date" name="dob" value="<?php echo $row['dob']; ?>"class="form-control"readonly>
      </div>

   <div class="col-md-4" style="z-index:1">
        Place of Birth <input type="text" name="place_of_birth" value="<?php echo $row['place_of_birth']; ?>" class="form-control"readonly>
      </div>

   <div class="col-md-4" style="z-index:1">
       Gender <select name="gender" class="form-control" value="<?php echo $row['gender']; ?>"readonly><option></option><option>Male</option><option>Female</option></select>
      </div>

   <div class="col-md-4" style="z-index:1">
        Residential Address <input type="text" name="residential_address" value="<?php echo $row['residential_address']; ?>" class="form-control"readonly>
      </div>

   <div class="col-md-4" style="z-index:1">
        Home Town <input type="text" name="home_town" value="<?php echo $row['home_town']; ?>" class="form-control"readonly>
      </div>

   <div class="col-md-4" style="z-index:1">
        Nationality <input type="text" name="nationality" value="<?php echo $row['nationality']; ?>"class="form-control"readonly>
      </div>

   <div class="col-md-4" style="z-index:1">
        Postal Address <input type="text" name="postal_address" value="<?php echo $row['postal_address']; ?>" class="form-control"readonly>
      </div>

   <div class="col-md-4" style="z-index:1">
        Occupation <input type="text" name="occupation" value="<?php echo $row['occupation']; ?>" class="form-control"readonly>
      </div>

   <div class="col-md-4" style="z-index:1">
        Marital Status <select name="marital_status" class="form-control" value="<?php echo $row['marital_status']; ?>"readonly><option></option><option>Single</option><option>Married</option><option>Divorced</option><option>Widow</option></select>
      </div>

   <div class="col-md-4" style="z-index:1">
        Parental Status <select name="parental_status" class="form-control"readonly><option></option><option>Living</option><option>Deceased</option></select>
      </div>
...
-->
  ...
  <!--<div class="tab-pane fade" id="fini">
   ...
   Upload Image <input type="file" class="form-control" name="image"disabled>
      </div>
